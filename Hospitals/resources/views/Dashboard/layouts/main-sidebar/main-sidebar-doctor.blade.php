			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('invoices.index',1) }}">قائمة الكشوفات</a></li>
                     ...
                     <li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('doctor.list.patient') }}">قائمة المرضى</a></li>
							<li><a class="slide-item" href="{{ route('doctor.chat') }}">المحادثات الاخيره</a></li>
