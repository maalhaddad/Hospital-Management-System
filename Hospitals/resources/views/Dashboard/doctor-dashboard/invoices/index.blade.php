...
@section('content')
    ...
    <div class="row row-sm">
                            ...
                            <tbody>
                                @foreach ($invoices as $invoice)
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ route('patientDetails', $invoice->Patient->id) }}">{{ $invoice->Patient->name }}</a>
                                        </td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item" href="#"
                                                        ...
                                                        data-doctor_id="{{ auth()->user()->id }}" data-toggle="modal"
                                                        data-target="#add_diagnosis"><i
                                                    ...
                                                    <a class="dropdown-item" href="#"
                                                        ...
                                                        data-invoice_id="{{ $invoice->id }}"
                                                        data-doctor_id="{{ auth()->user()->id }}" data-toggle="modal"
                                                        data-target="#xray_conversion">
                                                        <i class="text-primary fas fa-x-ray"></i>&nbsp;&nbsp;تحويل الي
                                                        الاشعة</a>
        ...
        @include('Dashboard.doctor-dashboard.invoices.add_Laboratorie')
        <!-- /row -->
