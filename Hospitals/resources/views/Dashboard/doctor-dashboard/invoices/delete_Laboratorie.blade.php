<!-- Modal -->
<div class="modal fade" id="delete_laboratorie" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div {{-- class="modal-dialog"  --}} class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">حذف بيانات الفحص</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('Laboratorie.destroy','null') }}" method="POST">
                @csrf
                @method('DELETE')
                <div class="modal-body">
                    ...
                    <p class="h5 text-danger"> هل انت متاكد من حذف بيانات الفحص ؟ </p>
