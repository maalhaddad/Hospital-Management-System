...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">تفاصيل المريض</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    {{ $patient->name }}</span>
            </div>
        </div>
    </div>
                                                                ...
                                                                @if ($patient_ray->case == 0)
                                                                     <td>
                                                                        <a class="modal-effect btn btn-sm btn-primary"
                                                                            ...
                                                                            data-target="#edit_xray_conversion"
                                                                        ...
                                                                        <a class="modal-effect btn btn-sm btn-danger"
                                                                            data-ray_id="{{ $patient_ray->id }}"
                                                                            data-description="{{ $patient_ray->description }}"
                                                                            data-effect="effect-scale" data-target="#delete_xray"
                                                                            data-toggle="modal" href="#"><i
                                                                 ...
                                                                 @if ($patient_Laboratorie->case == 0)
                                                                  ...
                                                                  <td>
                                                                        <a class="modal-effect btn btn-sm btn-primary"
                                                                            ...
                                                                            data-target="#edit_laboratorie" data-toggle="modal"
