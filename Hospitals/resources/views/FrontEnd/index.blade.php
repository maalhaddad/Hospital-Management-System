                    ...
                    <div class="auto-container">
                        <div class="row clearfix">
                            ...
                            <div class="image-column col-lg-6 col-md-12 col-sm-12">
                                <div class="inner-column">
                                    <div class="image">
                                        <img src="{{URL::asset('FrontEnd/images/main-slider/3.png')}}" alt=""/>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="image-column col-lg-5 col-md-12 col-sm-12">
                        <div class="inner-column wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="image">
                                <img style="width:594px; height:428; object-fit:cover;"
                                 src="{{URL::asset('FrontEnd/images/main-slider/drss.png')}}" alt=""/>
                            </div>
                        </div>
                    </div>
        ...
        <div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <div class="team-block col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="250ms" data-wow-duration="1500ms">
                        <div class="image">
                            <img src="{{ URL::asset('FrontEnd/images/resource/team-2.jpg') }}" alt=""/>
                            <div class="overlay-box">
                                <ul class="social-icons">
                                    <li><a href="#"><span class="fab fa-facebook-f"></span></a></li>
                                    <li><a href="#"><span class="fab fa-google"></span></a></li>
