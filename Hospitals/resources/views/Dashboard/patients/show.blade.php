                                                ...
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    ...
                                                    @foreach($Patient->Invoices as $invoice)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {{ ($invoice->invoice_type == 1) ? $invoice->Service->name :  $invoice->Group->name }}
                                                            </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="alert alert-primary">{{ number_format( $Patient->totalInvoicesAmount(),2) }}</td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="tab3">
                                            <div class="table-responsive">
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    ...
                                                    <tbody>
                                                    @foreach($Patient->Receipt_accounts as $receipt_account)
                                                        <tr>
                                                            <td>{{$loop->iteration}}</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="4"
                                                            class="alert alert-primary">{{ number_format( $Patient->Receipt_accounts->sum('amount') , 2)}}</td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="tab4">
                                            <div class="table-responsive">
                                                <table class="table table-hover text-md-nowrap text-center" id="example1">
                                                    ...
                                                    <tbody>
                                                    @foreach($Patient->Patient_accounts as $Patient_account)
                                                        <tr>
                                                            {{-- <?php //dd($Patient->Patient_accounts) ?> --}}

                                                            <td>{{$loop->iteration}}</td>
                                                            <td>{{$Patient_account->date}}</td>
                                                            <td>
                                                                @if(isset($Patient_account->Invoice->Service))
                                                                ...
                                                                @elseif($Patient_account->PaymentAccount == true)
                                                                 ...
                                                                 @elseif($Patient_account->Invoice->Group == true)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="alert alert-primary">{{ number_format( $Debit = $Patient->Patient_accounts->sum('Debit'), 2) }}</td>
                                                        <td class="alert alert-primary">{{ number_format( $credit = $Patient->Patient_accounts->sum('credit'), 2) }}</td>
