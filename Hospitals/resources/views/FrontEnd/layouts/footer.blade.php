                        ...
                        <div class="row clearfix">
                            ...
                            <div class="footer-column col-lg-7 col-md-6 col-sm-12">
                                <div class="footer-widget logo-widget">
									<div class="logo">
                                    	<a href="index.html"><img src="{{URL::asset('FrontEnd/images/logo-3.png')}}" alt="" /></a>
                                    </div>
                            ...
                            <div class="footer-widget news-widget">
                                ...
                                <div class="news-widget-block">
                                    <div class="widget-inner">
                                        <div class="image">
                                           {{-- <img src="{{URL::asset('FrontEnd/images/resource/news-image-1.jpg')}}" alt="" /> --}}
                                        </div>
                                ...
                                <div class="news-widget-block">
                                    <div class="widget-inner">
                                        <div class="image">
                                            {{-- <img src="{{URL::asset('FrontEnd/images/resource/news-image-2.jpg')}}" alt="" /> --}}
                                        </div>
