                                 ...
                                 <div class="table-responsive">
                                     <table class="table table-striped mg-b-0 text-md-nowrap" style="text-align: center">
                                         ...
                                         <tr>
                                             <th scope="row">1</th>
                                             <td>
                                                 <select wire:model="invoice.service_id" class="form-control" wire:change="get_price" id="exampleFormControlSelect1">
                                             ...
                                             <td><input wire:model="invoice.discount_value" wire:input="Total_with_tax($event.target.value)" type="text" class="form-control"></td>
                                             <th><input wire:model="invoice.tax_rate" type="text" class="form-control"></th>
                                             <td><input type="text" wire:model="invoice.tax_value" class="form-control" value="{{$invoice->tax_value}}" readonly ></td>
                                             <td><input type="text"  wire:model= "invoice.total_with_tax" class="form-control" value="{{ $subTotal }}" readonly ></td>
                                         </tr>
                                         </tbody>
                                     </table>
                                 </div><!-- bd -->
